...
const About2 = () => {
  ...
  return (
    <div className="text-[#F0E3CA]" id="about">
      <Message />
      <div
        className="mx-[5%] my-[60px]"
        onMouseMove={(e: any) => {
          setMouseMovement(e);
        }}
      >
        <h1 className="text-[3vw] font-bold mb-6 z-20 relative">About Me</h1>
        <div className=" relative py-20">
          ...
          <div className="relative md:hidden z-[41] mt-9  p-4">
            <p>
              ...
              frameworks, I ensure that the websites I build not only function
              seamlessly but also provide a visually engaging and user-friendly
              experience.
            </p>
          </div>
